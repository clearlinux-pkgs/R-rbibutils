...
Version  : 1.4
Release  : 2
URL      : https://cran.r-project.org/src/contrib/rbibutils_1.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rbibutils_1.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604677122
