...
Version  : 2.2.2
Release  : 14
URL      : https://cran.r-project.org/src/contrib/rbibutils_2.2.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rbibutils_2.2.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627928369
